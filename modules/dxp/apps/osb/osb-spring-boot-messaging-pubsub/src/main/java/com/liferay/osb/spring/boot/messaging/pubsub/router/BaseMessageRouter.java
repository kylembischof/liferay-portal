...
package com.liferay.osb.spring.boot.messaging.pubsub.router;

import com.liferay.osb.spring.boot.messaging.pubsub.Message;
import com.liferay.osb.spring.boot.messaging.pubsub.subscriber.MessageSubscriber;
...
public class BaseMessageRouter implements MessageRouter {
	...
	public void route(String topic, Message message) {
		...
		if (messageSubscribers.isEmpty() && _log.isDebugEnabled()) {
